...
module.exports.__inject__ = function (context) {
  add("981075a8", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CarouselComponent_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(105);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CarouselComponent_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CarouselComponent_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CarouselComponent_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CarouselComponent_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".v-responsive__content{width:600px!important}.carousel__text{width:600px;height:500px;display:flex;justify-content:space-between;align-items:center;flex-direction:column}.carousel__text h2{background:hsla(0,0%,100%,.6);padding:5px 10px;display:inline;width:100%}.carousel__text a{background:#000;padding:7px 12px;text-align:center;color:#fff!important;font-size:25px;text-decoration:none;border-radius:8px;oapcity:1;transition:.3s}.carousel__text a:hover{opacity:.7}.v-window__next{right:0}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/CarouselComponent.vue?vue&type=template&id=17d8e35c&
var CarouselComponentvue_type_template_id_17d8e35c_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.items)?_c('div',[_c('v-carousel',{staticClass:"carousel",attrs:{"show-arrows":true,"hide-delimiters":""}},_vm._l((_vm.items),function(item,i){return _c('v-carousel-item',{key:i,attrs:{"src":_vm.returnSource(item.preview_image)}},[_c('div',{staticClass:"carousel__text"},[_c('h2',[_vm._v(_vm._s(item.shortDesc)+"...")]),_vm._v(" "),_c('router-link',{attrs:{"to":'articles/' + item.id}},[_vm._v("читать далее")])],1)])}),1)],1):_vm._e()}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/CarouselComponent.vue?vue&type=template&id=17d8e35c&

// EXTERNAL MODULE: external "vuex"
var external_vuex_ = __webpack_require__(19);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/CarouselComponent.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var CarouselComponentvue_type_script_lang_js_ = ({
  data() {
    return {
      items: null
    };
...
// CONCATENATED MODULE: ./components/CarouselComponent.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_CarouselComponentvue_type_script_lang_js_ = (CarouselComponentvue_type_script_lang_js_); 
...
var VCarousel = __webpack_require__(111);

// EXTERNAL MODULE: ./node_modules/vuetify/src/components/VWindow/VWindow.sass
var VWindow = __webpack_require__(113);
...
function inserted(el, binding, vnode) {
  ...
  Object(helpers["l" /* keys */])(handlers).forEach(eventName => {
  ...
  methods: {
    ...
    genIcon(direction, icon, click) {
      ...
      const children = (_this$$scopedSlots$di = (_this$$scopedSlots$di2 = (_this$$scopedSlots = this.$scopedSlots)[direction]) == null ? void 0 : _this$$scopedSlots$di2.call(_this$$scopedSlots, {
        on,
        attrs
      })) != null ? _this$$scopedSlots$di : [this.$createElement(VBtn["a" /* default */], {
        props: {
          icon: true
        },
        attrs,
...
const baseMixins = Object(mixins["a" /* default */])(bootable, Object(groupable["a" /* factory */])('windowGroup', 'v-window-item', 'v-window'));
...
// CONCATENATED MODULE: ./components/CarouselComponent.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  components_CarouselComponentvue_type_script_lang_js_,
  CarouselComponentvue_type_template_id_17d8e35c_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
...
/* harmony default export */ var CarouselComponent = __webpack_exports__["default"] = (component.exports);

/* vuetify-loader */



installComponents_default()(component, {VCarousel: VCarousel_VCarousel,VCarouselItem: VCarouselItem})
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".main_heading{margin:200px 0;text-align:center;font-size:42px}.carousel__wrapper{height:100vh;max-width:80%;margin:auto;display:flex;justify-content:center;align-items:center;flex-direction:column}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=75f81a90&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<h1 class=\"main_heading\">\n    Приветствуем на новостном блоге московского политеха\n  </h1> "),_vm._ssrNode("<div class=\"carousel__wrapper\">","</div>",[_vm._ssrNode("<h2 class=\"carousel__title\">Последние новости:</h2> "),_c('Carousel')],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=75f81a90&

// EXTERNAL MODULE: ./components/CarouselComponent.vue + 13 modules
var CarouselComponent = __webpack_require__(120);
...
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({
  name: 'IndexPage',
  components: {
    Carousel: CarouselComponent["default"]
  },
...
"use strict";
/* harmony import */ var _VBtn__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(93);
